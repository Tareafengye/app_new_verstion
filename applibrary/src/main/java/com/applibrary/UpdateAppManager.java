...
import com.applibrary.DialogActivity;
import com.applibrary.HttpManager;
import com.applibrary.UpdateAppBean;
import com.applibrary.UpdateCallback;
import com.applibrary.service.DownloadService;
import com.applibrary.utils.Utils;
...
public class UpdateAppManager {
    ...
    public final static String UPDATE_APP_KEY = "UPDATE_APP_KEY";
    ...
    public void checkNewApp(final UpdateCallback callback) {
        Log.d("callbackcallback", callback + "");
        if (callback == null) {
            return;
        }
        callback.onBefore();
        ...
        Log.d("versionNamename", versionName + "");
    ...
    private void processData(String result, @NonNull UpdateCallback callback) {
        try {
            ...
            if (!getVersionCode(mActivity).equals(mUpdateApp.getNew_version())) {
 ...
 */
    ...
    public static class Builder {
        ...
        public Builder setUpdateUrl(String updateUrl) {
            ...
            Log.d("updateUrlupdateUrl", mUpdateUrl + "");
            return this;
        }
